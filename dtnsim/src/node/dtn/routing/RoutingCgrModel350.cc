...
void RoutingCgrModel350::identifyProximateNodes(BundlePkt *bundle, double simTime,
                                                vector<int> excludedNodes,
                                                vector<ProximateNode> *proximateNodes) {
...
void RoutingCgrModel350::tryRoute(BundlePkt *bundle, CgrRoute *route,
                                  vector<ProximateNode> *proximateNodes) {
...
void RoutingCgrModel350::findNextBestRoute(Contact *rootContact, int terminusNode,
                                           CgrRoute *route) {
    // increment counter
    dijkstraCalls++;
