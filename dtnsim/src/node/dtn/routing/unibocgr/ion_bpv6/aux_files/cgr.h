...
typedef void (*CgrTraceFn)(void *data, unsigned int lineNbr, CgrTraceType traceType, ...);
typedef struct {
...
extern int cgr_identify_best_routes(IonNode *terminusNode, Bundle *bundle, Lyst excludedNodes,
...
extern int cgr_preview_forward(uvast terminusNodeNbr, Bundle *bundle, time_t atTime, CgrSAP sap,
                               CgrTrace *trace);
