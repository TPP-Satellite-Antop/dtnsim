...
void RoutingCgrModel350_Hops::identifyProximateNodes(BundlePkt *bundle, double simTime,
                                                     vector<int> excludedNodes,
                                                     vector<ProximateNode> *proximateNodes) {
...
void RoutingCgrModel350_Hops::tryRoute(BundlePkt *bundle, CgrRoute *route,
                                       vector<ProximateNode> *proximateNodes) {
...
void RoutingCgrModel350_Hops::findNextBestRoute(Contact *rootContact, int terminusNode,
                                                CgrRoute *route) {
    // increment counter
    dijkstraCalls++;
...
void RoutingCgrModel350_Hops::enqueueToNeighbor(BundlePkt *bundle,
