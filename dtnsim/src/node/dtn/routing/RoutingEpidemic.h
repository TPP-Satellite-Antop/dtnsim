 ...
 *      Author: FRaverta
 *
 * This class provides a simplified implementation of Epidemic routing scheme proposed by Vahdat and
 * Becker in "Epidemic routing for partially connected ad-hoc networks, Technical Report CS-200006.
 * Duke University; 2000".
 *
 * Description of the Epidemic routing behavior:
 *
 * 		1) When a contact starts it enqueue to send all bundles whose destination is the
