 ...
 *      Author: FRaverta
 *
 * This class provides an implementation of Spray and Wait routing scheme proposed by T.
 *Spyropoulos, K. Psounis and C. S. Raghavendra in "Spray and Wait: An Efficient Routing Scheme for
 *Intermittently Connected Mobile Networks, Proceedings of ACM SIG-COMM Workshop on Delay-Tolerant
 ...
 *binary=false, it only sends one copy to next node. Otherwise it sends bundlesCopies/2.
 */
